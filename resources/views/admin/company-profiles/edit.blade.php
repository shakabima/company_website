...
<div class="container">
    ...
    <form action="{{ route('admin.company-profiles.update', $companyProfile->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone', $companyProfile->phone) }}" required>
        </div>

        <div class="mb-3">
            <label for="email" class="form-label">Email</label>
            <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $companyProfile->email) }}" required>
        </div>
